...
@NamedQueries({
        ...
        @NamedQuery(name = "Contact.findAllWithDetail",
                query = "SELECT DISTINCT c FROM Contact c LEFT JOIN FETCH c.contactTelDetailSet t LEFT JOIN FETCH c.hobbySet h"),
        @NamedQuery(name = "Contact.findById",
                query = "SELECT DISTINCT c FROM Contact c LEFT JOIN FETCH c.contactTelDetailSet t LEFT JOIN FETCH c.hobbySet h WHERE c.id = :id")
})
@SqlResultSetMapping(
        name = "contactResult",
